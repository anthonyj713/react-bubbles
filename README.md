...
- [ ] Explain what a token is used for.
  ...
  - A token is an encrypted key that allows access to whatever endpoint it allows it to.'

- [ ] What steps can you take in your web apps to keep your data secure?

 - You could use protected routes and tokens to keep data more secure.

- [ ] Describe how web servers work.

 - Client makes a request, server gives a response back. Rinse and repeat.

- [ ] Which HTTP methods can be mapped to the CRUD acronym that we use when interfacing with APIs/Servers.

  - Create, Read, Update, Delete. Put maps to Create and Update. Post maps to Create.
